...
const testimonials = [
  {
    ...
    role: 'Cardiologista',
    avatar: 'MS',
    content: 'O HealthFlow transformou minha clinica. Antes eu perdia horas com papelada, agora tenho tudo organizado.',
    rating: 5,
  },
  {
    ...
    role: 'Clinico Geral',
    avatar: 'CS',
    content: 'A telemedicina do HealthFlow e impecavel. Consigo atender pacientes de outras cidades com qualidade.',
    rating: 5,
  },
  {
    name: 'Ana Oliveira',
    ...
    avatar: 'AO',
    content: 'Os relatorios financeiros me ajudam a tomar decisoes estrategicas. Aumentamos o faturamento em 40%.',
    rating: 5,
  },
];
        ...
        <section id="planos" className="py-20">
          <div className="container">
            <div className="mx-auto max-w-2xl text-center">
              ...
              <p className="mt-4 text-muted-foreground">
                Escolha o plano ideal para sua clinica
              </p>
            </div>
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            <div className="space-y-4">
              ...
              <p className="text-sm text-muted-foreground">
                Sistema completo de gestao de saude para clinicas e consultorios.
              </p>
            </div>
